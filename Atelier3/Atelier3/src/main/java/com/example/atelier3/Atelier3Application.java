    ...
    CommandLineRunner CommandLineRunner(PatientRepository patientRepository){
        return args -> {
            patientRepository.save(
                    new Patient(null, "manal", new Date(), false, 12));
            patientRepository.save(
                    new Patient(null, "Mohamed", new Date(), true, 12));
            patientRepository.save(
                    new Patient(null, "Yazid", new Date(), true, 12));
            patientRepository.save(
                    new Patient(null, "salomon", new Date(), false, 12));
